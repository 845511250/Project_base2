package com.pro.hjy.project_base2.net.interceptor;
...
/**
 * The Http Logger filter
 */
public class FInterceptor implements Interceptor {
    ...
    public FInterceptor(Logger logger) {
        this.logger = logger;
    }

    /** Change the level at which this interceptor logs. */
    public FInterceptor setLevel(Level level) {
